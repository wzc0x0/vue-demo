      ...
      <div class="account_info">
        <table class="account_info_wrap">
          ...
          <tr>
            ...
            <td v-show="!isBindingCard">您已绑定银行对公账户：尾号{{tailNum}}<span class="binding" @click="unbind('SYS_GENERATE_007')">解绑</span></td>
          </tr>
          </tbody>
  ...
  export default {
    ...
    methods:{
      ...
      bindBankCard(){
        ...
        this.$refs.bingCard.form.whichClick = "SYS_GENERATE_007";
      },
    ...
    mounted(){
      this.$http.post("/api/order/selectDownOrder",addSign({
        "platformUserNo":"SYS_GENERATE_007",
        "orderType":"4001",
        "orderSource":"1",
        "orgCode":"xwbank"
      })).then((res)=>{
